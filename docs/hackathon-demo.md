...
The final AquaSense demonstration will move from the ESP32 software prototype to an **STM32G4-based physical transmitter**, with the electrical waveform verified using an **oscilloscope**.
